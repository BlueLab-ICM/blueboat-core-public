...
<Note>
This documentation accompanies the OCEANS 2026 Monterey paper *An adaptive open-source architecture for enhanced autonomy in BlueBoat ASVs based on ROS2*, from the BLUE Lab at ICM-CSIC, Barcelona.
</Note>
